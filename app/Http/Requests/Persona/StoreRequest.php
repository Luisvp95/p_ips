...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email'=>'nullable|string|unique:personas|max:50|email:rfc,dns',
            'direccion'=>'nullable|string|max:255',
            'carnet'=>'required|numeric|unique:personas|digits_between:6,10',
            'celular' => 'nullable|numeric|unique:personas|digits_between:8,10',
