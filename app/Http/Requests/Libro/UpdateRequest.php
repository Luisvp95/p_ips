...
class UpdateRequest extends FormRequest
{
    ...
    {
        return [
            'nombre'=>'required|unique:libros,nombre,'. $this->route('libro')->id.'|string|max:100',
            'editorial'=>'required|unique:libros,editorial,'. $this->route('libro')->id.'|string|max:50',
            'anyo'=>'required|numeric|between:1970,' . date('Y'),
