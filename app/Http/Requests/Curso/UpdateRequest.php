...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'nombre'=>'required|string|unique:cursos,nombre,'. $this->route('curso')->id.'|max:255',
            'imagen'=>'nullable|dimensions:min_width=100,min_height=200',
    ...
    public function messages()
    {
        return [
            ...
            'categoria_id.exists'=>'La catetgoria no existe',
